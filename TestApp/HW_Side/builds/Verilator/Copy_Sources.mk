...
rsync_srcs: all_srcs
	...
	$(RSYNC)  $(FLUTE_REPO)/src_bsc_lib_RTL/RegFile.v                                     all_srcs/
	$(RSYNC)  $(FLUTE_REPO)/src_bsc_lib_RTL/FIFO2.v                                       all_srcs/
	$(RSYNC)  $(FLUTE_REPO)/src_bsc_lib_RTL/SizedFIFO.v                                   all_srcs/

...
.PHONY: rsync_srcs
rsync_srcs: all_srcs  Verilog_RTL  rsync_BSV_lib_RTL  rsync_sv_toplevel
...
# ================================================================
# These files are boilerplate and contitute the outer-most
# SystemVerilog wrapper containing mkBluPont_HW_Side.v (generated by
# 'bsc' from BluPont_HW_Side.bsv).

.PHONY: rsync_sv_toplevel
rsync_sv_toplevel: $(DESIGN_RTL)
	@echo "INFO: Copying SV toplevel"
	$(RSYNC)  $(BLUPONT_REPO)/Platform_AWSF1/HW_Side/cl_dram_dma_defines.vh  Verilog_RTL/
	$(RSYNC)  $(BLUPONT_REPO)/Platform_AWSF1/HW_Side/cl_dram_dma.sv          Verilog_RTL/
	$(RSYNC)  $(BLUPONT_REPO)/Platform_AWSF1/HW_Side/cl_id_defines.vh        Verilog_RTL/

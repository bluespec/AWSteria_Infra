...
void *BluPont_Host_Side_init (void)
{
    ...
    fprintf (stdout, "%s: calling fpga_dma_open_queue(... read)\n", __FUNCTION__);
    ...
    fprintf (stdout, "%s: calling fpga_dma_open_queue(... write)\n", __FUNCTION__);
    ...
    fprintf (stdout, "%s: calling fpga_pci_attach(): pci_pf_id %0d, pci_bar_id %0d, pci_bar_handle %0x\n",
	     __FUNCTION__,
